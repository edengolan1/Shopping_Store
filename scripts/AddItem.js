...
function AddItem(imageSrc, company, nameItem, price, discount, colors, sizes, smallImages){
...
function NumberItems(countItems){
    var numbers = document.getElementById('numberItems');
    numbers.innerHTML = `
    <span>פריטים</span>
